...
#import tkinter module, from tkinter import all widgets(*)
#could also call a specific widget from tkinter as well

import tkinter
from tkinter import *


#class used to create a tkinter window
...
if __name__ == "__main__":
    ...
    #this makes it so the window stays open rather than open and close right away
    root.mainloop()
